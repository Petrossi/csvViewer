    ...
    !function () {
        ...
        function t() {
            ...
            return e.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, i), e.setAttribute("title", s.title), o.setMultiple(s.multiple, e), s.folders && qq.supportedFeatures.folderSelection && e.setAttribute("webkitdirectory", ""), s.acceptFiles && e.setAttribute("accept", s.acceptFiles), e.setAttribute("type", "file"), e.setAttribute("name", s.name), qq(e).css({
                ...
                cursor: "pointer",
                opacity: 0
            }), !qq.ie7() && qq(e).css({height: "100%"}), s.element.appendChild(e), r.attach(e, "change", function () {
                s.onChange(e)
        ...
        var n, i, o = this, r = new qq.DisposeSupport, s = {
            acceptFiles: null,
            element: null,
        ...
        qq.extend(this, {
            addFile: function (t) {
                ...
                var i = o[t].status, r = qq.indexOf(s[i], t);
        ...
        qq.basePublicApi = {
            addBlobs: function (e, t, n) {
                ...
                return this._imageGenerator ? (r = this._thumbnailUrls[e], s = {
                    ...
                    a.failure({container: e, error: t || "Problem generating thumbnail"})
                })) : a.failure({container: t, error: "Missing image generator module"}), a
            ...
            _addCannedFile: function (e) {
                ...
                var n = this, i = {}, o = {
                    ...
                    onComplete: function (e, t, o, r) {
                        delete i[e];
                        var s, a = n.getUploads({id: e}).status;
                ...
                if (this._options.camera.ios && qq.ios()) {
                    var e = "image/*;capture=camera", t = this._options.camera.button,
                        n = t ? this._getButtonId(t) : this._defaultButtonId, i = this._options;
                ...
                var i = this, o = qq.getUniqueId(), r = -1, s = qq.getFilename(e), a = e.blob || e,
                ...
                var s = this._uploadData.addFile({uuid: n, name: t, size: i, batchId: r});
                this._handler.add(s, e), this._trackButton(s), this._netUploadedOrQueued++, o.push({id: s, file: e})
                ...
                var o, r, s = this._options.messages[e], a = [], u = [].concat(t), l = u[0], c = this._getButtonId(n),
                ...
                if (t.length > n) if (e || !this._options.validation.stopOnFirstInvalidFile) setTimeout(function () {
                    var e = r._getValidationDescriptor(t[n]), s = r._getButtonId(t[n].file), a = r._getButton(s);
                ...
                var r, s = this._currentItemLimit, a = this._netUploadedOrQueued;
                ...
                var o = this, r = t + 1, s = this._getValidationDescriptor(e[t]);
                ...
                var n = this, i = function () {
                    ...
                    }(), o = t.name, r = t.size, s = this._getButtonId(e.file), a = this._getValidationBase(s),
                    u = new qq.Promise;
        ...
        function l(e, t) {
            var n, o = r(e, t), s = y.method, a = u(e), l = S[e].payload;
        ...
        function f(e) {
            var o = r(e), s = y.customHeaders, a = S[e].additionalHeaders || {}, u = y.method, l = {};
        ...
        function g(e, t, n, i, o, r, s) {
            S[e] = {addToPath: n, additionalParams: i, additionalQueryParams: o, additionalHeaders: r, payload: s};
            var a = b.push(e);
        ...
        qq.extend(this, {
            add: function (e, t) {
                ...
                var t = this, r = new qq.Promise, s = i(e, o(e), r);
                s.then(function () {
        ...
        var n, i, o, r = this, s = !1, a = !1, u = {
            ...
            getIdsInBatch: function (e) {
                ...
                var t = u.getSize(e), n = u.getName(e), r = l.nextPart(e), s = o._getChunkData(e, r),
                    d = o._getFileState(e).attemptingResume, q = o._getFileState(e).chunking.inProgress || [];
                null == o._getFileState(e).loaded && (o._getFileState(e).loaded = 0), d && u.onResume(e, n, s) === !1 && (l.reset(e), r = l.nextPart(e), s = o._getChunkData(e, r), d = !1), null == r && 0 === q.length ? l.finalize(e) : (i(qq.format("Sending chunked upload request for item {}.{}, bytes {}-{} of {}.", e, r, s.start + 1, s.end, t)), u.onUploadChunk(e, n, o._getChunkDataForCallback(s)), q.push(r), o._getFileState(e).chunking.inProgress = q, a && c.open(e, r), a && c.available() && o._getFileState(e).chunking.remaining.length && l.sendNext(e), o.uploadChunk(e, r, d).then(function (t, n) {
                    ...
                    var s = o._getFileState(e).chunking.inProgress || [], a = p.normalizeResponse(t, !0),
                        u = qq.indexOf(s, r);
            ...
            _open: [], _openChunks: {}, _waiting: [], available: function () {
                ...
                var n, r = !t, s = qq.indexOf(c._waiting, e), a = qq.indexOf(c._open, e);
            ...
            send: function (e, t) {
                o._getFileState(e).loaded = 0, i("Sending simple upload request for " + e), o.uploadFile(e).then(function (n, o) {
                    ...
                    var r = p.normalizeResponse(n, !0), s = u.getSize(e);
        ...
        function o(e, t) {
            ...
            l[r] = t, c[o] = qq(e).attach("load", function () {
                ...
                var t, o = (n(i), s._parseJsonResponse(e)), r = o.uuid;
        ...
        var r = e.options, s = this, a = e.proxy, u = qq.getUniqueId(), l = {}, c = {}, d = {}, p = r.isCors,
            q = r.inputName, h = a.getUuid, f = a.log, m = new qq.WindowReceiveMessage({log: f});
        qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function (e) {
            return {
                add: function (t, n) {
                    e.add(t, {input: n}), n.setAttribute("name", q), n.parentNode && qq(n).remove()
                }, expunge: function (n) {
                    t(n), e.expunge(n)
                }, isValid: function (t) {
            ...
            getInput: function (e) {
                ...
                var t = e.method, n = e.endpoint, i = e.params, o = e.paramsInBody, r = e.targetName,
                    s = qq.toElement("<form method='" + t + "' enctype='multipart/form-data'></form>"), a = n;
        ...
        var n = this, i = e.options.namespace, o = e.proxy, r = e.options.chunking, s = e.options.resume,
            a = r && e.options.chunking.enabled && qq.supportedFeatures.chunking,
            u = s && e.options.resume.enabled && a && qq.supportedFeatures.resume, l = o.getName, c = o.getSize,
            d = o.getUuid, p = o.getEndpoint, q = o.getDataByUuid, h = o.onUuidChanged, f = o.onProgress, m = o.log;
        qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function (e) {
            return {
                add: function (t, i) {
            ...
            clearCachedChunk: function (e, t) {
                ...
                var i = r.partSize, o = c(e), s = n.getFile(e), a = i * t, u = a + i >= o ? o : a + i,
                    l = n._getTotalChunks(e), d = this._getFileState(e).temp.cachedChunks,
                    p = d[t] || qq.sliceBlob(s, a, u);
                return d[t] = p, {part: t, start: a, end: u, count: l, blob: p, size: u - a}
                ...
                var t = "5.0", n = l(e), o = c(e), s = r.partSize, a = p(e);
                ...
                var o = n._getXhr(e, t), r = l(e), s = {
                    simple: function (t, n) {
                        var i = c(e);
                        t === n ? f(e, r, i, i) : f(e, r, t >= i ? i - 1 : t, i)
                    }, chunked: function (o, s) {
                        var a = n._getFileState(e).temp.chunkProgress, u = n._getFileState(e).loaded, l = o, d = s,
                            p = c(e), q = l - (d - i), h = u;
                ...
                var r = null == t ? -1 : t, s = n._getFileState(e).temp;
        ...
        function t(e, t, n) {
            var i, o, r, s, a = document.createElement("canvas"), u = 0, l = n, c = n;
        ...
        function n(e, t, n, i) {
            var r = document.createElement("canvas"), s = n.mime || "image/jpeg", a = new qq.Promise;
        ...
        function o(n, o, a, u, l) {
            var c, d = n.naturalWidth, p = n.naturalHeight, q = u.width, h = u.height, f = a.getContext("2d"),
                m = new qq.Promise;
            return f.save(), u.resize ? r({
                ...
                e(n) && (d /= 2, p /= 2);
                var i, o, r, s = 1024, a = document.createElement("canvas"), u = l ? t(n, d, p) : 1,
                    c = Math.ceil(s * q / d), m = Math.ceil(s * h / p / u), g = 0, _ = 0;
        ...
        function r(e) {
            var t = e.blob, n = e.image, i = e.imageHeight, o = e.imageWidth, r = e.orientation, a = new qq.Promise,
                u = e.resize, l = document.createElement("canvas"), c = l.getContext("2d"), d = e.canvas,
                p = e.targetHeight, q = e.targetWidth;
        ...
        a.prototype.render = function (e, t) {
            t = t || {};
            var i, r = this, s = this.srcImage.naturalWidth, a = this.srcImage.naturalHeight, u = t.width, l = t.height,
        ...
        function c(t, n, i) {
            var o = new qq.Promise, r = new qq.Identify(t, e), s = i.maxSize, a = null == i.orient || i.orient,
                u = function () {
            ...
            return r.isPreviewable().then(function (r) {
                ...
                }, d = a ? new qq.Exif(t, e) : c, p = new qq.MegaPixImage(t, u);
                l(n, o) && d.parse().then(function (e) {
                    var t = e && e.Orientation;
                    p.render(n, {maxWidth: s, maxHeight: s, orientation: t, mime: r, resize: i.customResizeFunction})
                }, function (t) {
        ...
        function q(e, r, a) {
            var u = new qq.Promise, c = a.scale, q = c ? a.maxSize : null;
        ...
        function l(e, t) {
            var i = 16, o = qq.extend([], c), r = {};
            return qq.each(t, function (t, s) {
                var a, u, l, c = s.slice(0, 4), p = e ? n(c) : parseInt(c, 16), q = o.indexOf(p);
        ...
        qq.extend(this, {
            isPreviewable: function () {
                var i = this, o = new qq.Promise, r = !1, s = void 0 === e.name ? "blob" : e.name;
        ...
        function n(e, n, o, r) {
            ...
            n = n && t(e), n && qq.each(e, function (e, t) {
                if (null == t.uuid) s = !0, i.log(qq.format("Session response item {} did not include a valid UUID - ignoring.", e), "error"); else if (null == t.name) s = !0, i.log(qq.format("Session response item {} did not include a valid name - ignoring.", e), "error"); else try {
        ...
        "use strict";
        var n = e.customResizer, i = e.sendOriginal, o = e.orient, r = e.defaultType, s = e.defaultQuality / 100,
            a = e.failureText, u = e.includeExif, l = this._getSortedSizes(e.sizes);
        qq.extend(this, {
            enabled: qq.supportedFeatures.scaling && l.length > 0, getFileRecords: function (e, c, d) {
                var p = this, q = [], h = d.blob ? d.blob : d, f = new qq.Identify(h, t);
                return f.isPreviewableSync() ? (qq.each(l, function (e, i) {
                    var l = p._determineOutputType({defaultType: r, requestedType: i.type, refType: h.type});
                    q.push({
                        uuid: qq.getUniqueId(),
                        name: p._getName(c, {name: i.name, type: l, refType: h.type}),
                ...
                }), q.push({uuid: e, name: c, size: h.size, blob: i ? h : null})) : q.push({
                    uuid: e,
                    name: c,
                    size: h.size,
                    blob: h
                ...
                var u = this, l = (e.qqButtonId || e.blob && e.blob.qqButtonId, []), c = null, d = a.addFileToHandler,
                    p = a.uploadData, q = a.paramsStore, h = qq.getUniqueId();
                qq.each(u.getFileRecords(n, t, e), function (e, t) {
                    ...
                    n[s] = p.retrieve({id: t}).uuid, p.setParentId(t, c), q.addReadOnly(t, n)
                }), l.length && !function () {
                    var e = {};
        ...
        scaleImage: function (e, t, n) {
            ...
            var i = new qq.Promise, o = n.log, r = n.getFile(e), s = n.uploadData.retrieve({id: e}), a = s && s.name,
                u = s && s.uuid, l = {
            ...
            "use strict";
            var n = e.lastIndexOf("."), i = t.type || "image/png", o = t.refType, r = "", s = qq.getExtension(e),
                a = "";
            ...
            "use strict";
            var n = this, i = e.customResizeFunction, o = e.log, r = e.maxSize, s = e.orient, a = e.type, u = e.quality,
                l = e.failedText, c = e.includeExif && "image/jpeg" === t.type && "image/jpeg" === a,
                d = new qq.Promise, p = new qq.ImageGenerator(o), q = document.createElement("canvas");
            return o("Attempting to generate scaled version for " + t.name), p.generate(t, q, {
                maxSize: r,
                orient: s,
                customResizeFunction: i
            }).then(function () {
                var e = q.toDataURL(a, u), i = function () {
        ...
        return e.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e.encode64 = function (e) {
            ...
            var n = this.getExifArray(t), i = this.insertExif(e, n), o = new Uint8Array(i);
            return o
            ...
            var t, n, i, o, r, s = "", a = "", u = 0, l = [], c = /[^A-Za-z0-9\+\/\=]/g;
        ...
        "use strict";
        var n = {}, i = 0, o = 0, r = -1, s = -1, a = function (t, n) {
            ...
            var s = n[e] ? n[e].loaded : 0, u = n[e] ? n[e].total : 0;
        ...
        var a = this, u = e.interceptSubmit, l = e.element, c = e.autoUpload;
        qq.extend(this, {
        ...
        function n(e, t) {
            ...
            try {
                ...
                a("Error when attempting to parse form upload response (" + e.message + ")", "error"), n = {success: !1}
            }
            return n
        }

        function i(t, n) {
            var i = e.paramsStore.get(t), a = "get" === e.method.toLowerCase() ? "GET" : "POST",
        ...
        var o = this, r = t.getName, s = t.getUuid, a = t.log;
        this.uploadFile = function (t) {
            var r, s = o.getInput(t), u = o._createIframe(t), l = new qq.Promise;
            ...
            proxy: {onCancel: e.onCancel, getName: r, getUuid: s, log: a}
        }))
    }, qq.traditional = qq.traditional || {}, qq.traditional.XhrUploadHandler = function (e, t) {
        "use strict";
        var n = this, i = t.getName, o = t.getSize, r = t.getUuid, s = t.log, a = e.forceMultipart || e.paramsInBody,
            u = function (t, n, r) {
                var s = o(t), u = i(t);
                ...
                var s = e.paramsStore.get(t), a = i(t), u = o(t);
                ...
                var l = new FormData, c = e.method, d = e.endpointStore.get(u), p = i(u), q = o(u);
        ...
        qq.extend(this, {
            uploadChunk: function (t, i, r) {
                var s, a, l, d = n._getChunkData(t, i), p = n._createXhr(t, i);
                o(t);
        ...
        function i(e, t, n, o) {
            var r = o || new qq.Promise, s = t || e.createReader();
        ...
        var l, c = "qq-hidezones", d = "qq-hide-dropzone", p = [], q = [], h = new qq.DisposeSupport;
        l = {
            dropZoneElements: [],
        ...
        qq.uiPublicApi = {
            ...
            _getButton: function (e) {
                ...
                function o(t) {
                    a && (s.setStatusText(e), qq(a).removeClass(u._classes.retrying), s.hideProgress(e), u.getUploads({id: e}).status !== qq.status.UPLOAD_FAILED && s.hideCancel(e), s.hideSpinner(e), t.success ? u._markFileAsSuccessful(e) : (qq(a).addClass(u._classes.fail), s.showCancel(e), s.isRetryPossible() && !u._preventRetries[e] && (qq(a).addClass(u._classes.retryable), s.showRetry(e)), u._controlFailureTextDisplay(e, t)))
                }

                var r = this._parent.prototype._onComplete.apply(this, arguments), s = this._templating,
                    a = s.getFileContainer(e), u = this;
                ...
                var i, o = this.getName(e), r = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g, o),
                    s = (this.getUuid(e), arguments), a = this;
                ...
                var i, o, r = 0, s = this._handler.isProxied(e) && this._options.scaling.hideScaled;
                ...
                var t = this._thumbnailUrls[e], n = this.getUploads({id: e}).status;
        ...
        "use strict";
        var t, n, i, o, r, s, a, u, l = "qq-file-id", c = "qq-file-id-", d = "qq-max-size", p = "qq-server-scale",
            q = "qq-hide-dropzone", h = "qq-drop-area-text", f = "qq-in-progress", m = "qq-hidden-forever",
            g = {content: document.createDocumentFragment(), map: {}}, _ = !1, v = 0, b = !1, S = [], y = -1, w = {
                log: null,
            ...
            }, x = {}, E = new qq.Promise, P = new qq.Promise, F = function () {
                var e = w.placeholders.thumbnailNotAvailable, n = w.placeholders.waitingForThumbnail,
                    i = {maxSize: y, scale: u};
                ...
                var n = x[e] || (new qq.Promise).failure(), i = new qq.Promise;
                ...
                var t = e.id, n = e.optFileOrBlob, i = n && n.qqThumbnailId, o = X(t),
                    r = {customResizeFunction: e.customResizeFunction, maxSize: y, orient: !0, scale: !0};
                ...
                var t = e.id, n = e.thumbnailUrl, i = e.showWaitingImg, o = X(t),
                    r = {customResizeFunction: e.customResizeFunction, scale: u, maxSize: y};
                if (o) if (n) {
                ...
                var n = L(e), i = null == e ? C.totalProgressBar : C.progressBar;
        ...
        qq.extend(w, e), t = w.log, qq.supportedFeatures.imagePreviews || (w.limits.timeBetweenThumbs = 0, w.limits.maxThumbs = 0), r = w.containerEl, a = void 0 !== w.imageGenerator, o = Y(), F(), qq.extend(this, {
            render: function () {
                ...
                var u, d = qq.toElement(o.fileTemplate), p = G(d, C.file), q = G(r, C.uploader), f = a ? g.content : s;
                ...
                this.isHiddenForever(e) || (S.push({id: e, customResizeFunction: n, optFileOrBlob: t}), !b && I())
                ...
                var i = D(e), o = G(i, C.dialogMessage), r = i.getElementsByTagName("INPUT")[0],
                    s = G(i, C.dialogCancelButton), a = G(i, C.dialogOkButton), u = new qq.Promise, l = function () {
        ...
        function t(e, t) {
            if (i.templating.isFileName(e) || i.templating.isEditIcon(e)) {
                var o = i.templating.getFileId(e), r = i.onGetUploadStatus(o);
        ...
        function n(e) {
            var t = a.onGetName(e), n = t.lastIndexOf(".");
        ...
        var n = {}, i = n.lib = {}, o = i.Base = function () {
            ...
            init: function (e, n) {
                ...
                } else if (n.length > 65535) for (var r = 0; r < o; r += 4) t[i + r >>> 2] = n[r >>> 2]; else t.push.apply(t, n);
            ...
            reset: function () {
                ...
                var n = this._data, i = n.words, o = n.sigBytes, s = this.blockSize, a = 4 * s, u = o / a;
                u = t ? e.ceil(u) : e.max((0 | u) - this._minBufferSize, 0);
                var l = u * s, c = e.min(4 * l, o);
                if (l) {
        ...
        var e = qq.CryptoJS, t = e.lib, n = t.WordArray, i = e.enc;
        i.Base64 = {
            stringify: function (e) {
                var t = e.words, n = e.sigBytes, i = this._map;
                e.clamp();
                for (var o = [], r = 0; r < n; r += 3) for (var s = t[r >>> 2] >>> 24 - r % 4 * 8 & 255, a = t[r + 1 >>> 2] >>> 24 - (r + 1) % 4 * 8 & 255, u = t[r + 2 >>> 2] >>> 24 - (r + 2) % 4 * 8 & 255, l = s << 16 | a << 8 | u, c = 0; c < 4 && r + .75 * c < n; c++) o.push(i.charAt(l >>> 6 * (3 - c) & 63));
                var d = i.charAt(64);
                if (d) for (; o.length % 4;) o.push(d);
                return o.join("")
            }, parse: function (e) {
                var t = e.length, i = this._map, o = i.charAt(64);
                if (o) {
                    var r = e.indexOf(o);
                    r != -1 && (t = r)
                }
                for (var s = [], a = 0, u = 0; u < t; u++) if (u % 4) {
        ...
        var e = qq.CryptoJS, t = e.lib, n = t.Base, i = e.enc, o = i.Utf8, r = e.algo;
        r.HMAC = n.extend({
            init: function (e, t) {
        ...
        var e = qq.CryptoJS, t = e.lib, n = t.WordArray, i = t.Hasher, o = e.algo, r = [], s = o.SHA1 = i.extend({
            _doReset: function () {
        ...
        var t = qq.CryptoJS, n = t.lib, i = n.WordArray, o = n.Hasher, r = t.algo, s = [], a = [];
        !function () {
            function t(t) {
        ...
        var u = [], l = r.SHA256 = o.extend({
            _doReset: function () {
                ...
                var t = this._data, n = t.words, i = 8 * this._nDataBytes, o = 8 * t.sigBytes;
        ...
        if ("function" == typeof ArrayBuffer) {
            var e = qq.CryptoJS, t = e.lib, n = t.WordArray, i = n.init, o = n.init = function (e) {
        ...
        return {
            ...
            getBucket: function (e) {
                var t,
                    n = [/^(?:https?:\/\/)?([a-z0-9.\-_]+)\.s3(?:-[a-z0-9\-]+)?\.amazonaws\.com/i, /^(?:https?:\/\/)?s3(?:-[a-z0-9\-]+)?\.amazonaws\.com\/([a-z0-9.\-_]+)/i, /^(?:https?:\/\/)?([a-z0-9.\-_]+)/i];
            ...
            generateAwsParams: function (e, t) {
                var n, i = {}, o = e.params, r = new qq.Promise, s = e.sessionToken, a = e.clockDrift, u = e.type,
                    l = e.key, c = e.accessKey, d = e.acl, p = e.expectedStatus,
                    q = qq.s3.util.getSuccessRedirectAbsoluteUrl(e.successRedirectUrl), h = e.reducedRedundancy,
                    f = e.region, m = e.serverSideEncryption, g = e.signatureVersion, _ = new Date, v = e.log;
            ...
            parseIframeResponse: function (e) {
                var t = e.contentDocument || e.contentWindow.document, n = t.location.search,
                    i = /bucket=(.+)&key=(.+)&etag=(.+)/.exec(n);
                if (i) return {bucket: i[1], key: i[2], etag: i[3].replace(/%22/g, "")}
            },
        ...
        qq.nonTraditionalBasePublicApi = {
            ...
            _onComplete: function (e, t, n, i) {
                var o, r, s = !!n.success, a = this, u = arguments, l = this._uploadSuccessEndpointStore.get(e),
                    c = this._options.uploadSuccess.customHeaders, d = this._options.uploadSuccess.method,
                    p = this._options.cors, q = new qq.Promise, h = this._uploadSuccessParamsStore.get(e),
                    f = this._paramsStore.get(e), m = function (t) {
        ...
        qq.s3.FineUploaderBasic = function (e) {
            var t = {
                ...
                objectProperties: {
                    acl: "private", bucket: qq.bind(function (e) {
                        return qq.s3.util.getBucket(this.getEndpoint(e))
                    }, this), host: qq.bind(function (e) {
            ...
            getBucket: function (e) {
                ...
                var n = this._options.objectProperties[t], i = new qq.Promise, o = this;
                ...
                var n = new qq.Promise, i = this._options.objectProperties.key, o = qq.getExtension(t), r = n.failure,
                    s = function (e, t) {
                        var i = e;
                ...
                var i = {key: this.getKey(e), uuid: this.getUuid(e), name: this.getName(e), bucket: this.getBucket(e)};
                return n && n.getResponseHeader("ETag") ? i.etag = n.getResponseHeader("ETag") : t.etag && (i.etag = t.etag), i
            }, _onSubmitDelete: function (e, t) {
                var n = {key: this.getKey(e), bucket: this.getBucket(e)};
        ...
        function t(e, t, n) {
            var i, o, r = t.responseText, s = l[e], a = s.promise, u = s.signatureConstructor;
            if (delete l[e], r) try {
                o = qq.parseJson(r)
            } catch (e) {
        ...
        function n(e, t, n) {
            var i, o, r, s = new qq.Promise, a = "POST", l = [], d = "", h = new Date, f = function (e) {
                var n, s = [];
        ...
        var s, a, u = this, l = {}, c = {
            ...
            getStringToSign: function (e) {
                ...
                var i = qq.CryptoJS.enc.Utf8.parse(t), o = qq.CryptoJS.HmacSHA1(i, a.get().secretKey),
                    r = qq.CryptoJS.enc.Base64.stringify(o);
                d(e, r, n)
            }, signPolicy: function (e, t, n, i) {
                var o = JSON.stringify(e), r = qq.CryptoJS.enc.Utf8.parse(o), s = qq.CryptoJS.enc.Base64.stringify(r),
                    u = qq.CryptoJS.HmacSHA1(s, a.get().secretKey), l = qq.CryptoJS.enc.Base64.stringify(u);
                t.success({policy: s, signature: l}, n, i)
            }
        }, q = {
            getCanonicalQueryString: function (e) {
                var t, n, i, o = e.indexOf("?"), r = "";
                ...
                return qq.isBlob(e) ? (t = new FileReader, t.onloadend = function (e) {
                    if (e.target.readyState === FileReader.DONE) if (e.target.error) n.failure(e.target.error); else {
                ...
                var t = q.getCanonicalRequest(e), n = qq.s3.util.getV4PolicyDate(e.date, e.drift),
                    i = qq.CryptoJS.SHA256(t).toString(), o = q.getScope(e.date, c.signatureSpec.region),
                    r = "AWS4-HMAC-SHA256\n{}\n{}\n{}";
                return {hashed: qq.format(r, n, o, i), raw: qq.format(r, n, o, t)}
                ...
                var o, r, s, u, l, c = JSON.stringify(e), d = qq.CryptoJS.enc.Utf8.parse(c),
                    p = qq.CryptoJS.enc.Base64.stringify(d), q = a.get().secretKey,
                    h = /.+\/(.+)\/(.+)\/s3\/aws4_request/, f = function () {
                        var t = null;
        ...
        qq.extend(c, e, !0), a = c.signatureSpec.credentialsProvider, s = qq.extend(this, new qq.AjaxRequester({
            ...
            getSignature: function (e, t) {
                var n, o = t, r = t.signatureConstructor, u = new qq.Promise;
                return 4 === c.signatureSpec.version && (n = {v4: !0}), a.get().secretKey && qq.CryptoJS ? a.get().expiration.getTime() > Date.now() ? i(e, t, u) : a.onExpired().then(function () {
                    ...
                    o = {headers: t.stringToSignRaw}, s.initTransport(e).withParams(o).withQueryParams(n).send()
                ...
                return {
                    withHeaders: function (e) {
                        ...
                        var h = a.get().sessionToken, f = new qq.Promise,
        ...
        function t(e, t, n) {
            var r, s = i[e], a = t.responseText, u = {success: !0}, l = {success: !1};
        ...
        function t(e) {
            var t, n = s.getBucket(e), i = s.getHost(e), r = {}, a = new qq.Promise, u = s.getKey(e);
            ...
            }), t = o.constructStringToSign(o.REQUEST_TYPE.MULTIPART_INITIATE, n, i, u).withContentType(s.getContentType(e)).withHeaders(r), o.getSignature(e, {signatureConstructor: t}).then(a.success, a.failure), a
        }

        function n(e, t, n) {
            var i, o, a, u, l, c = r[e], d = new DOMParser, p = d.parseFromString(t.responseText, "application/xml");
        ...
        function t(e, t, n) {
            var i = new qq.Promise, o = a.getBucket(e), s = a.getHost(e),
            ...
            return r.getSignature(e, {signatureConstructor: u}).then(i.success, i.failure), i
        }

        function n(e, t, n) {
            var i = s[e], o = new DOMParser, r = a.getBucket(e),
                u = (a.getKey(e), o.parseFromString(t.responseText, "application/xml")),
                l = u.getElementsByTagName("Bucket"), c = u.getElementsByTagName("Key");
        ...
        function i(e) {
            ...
            return e.sort(function (e, t) {
                ...
                var i = n.part, o = n.etag, r = t.createElement("Part"), s = t.createElement("PartNumber"),
                    a = t.createTextNode(i), u = t.createTextNode(o), l = t.createElement("ETag");
        ...
        function t(e, t) {
            var n = new qq.Promise, i = r.getBucket(e), s = r.getHost(e),
                a = o.constructStringToSign(o.REQUEST_TYPE.MULTIPART_ABORT, i, s, r.getKey(e)).withUploadId(t);
            return o.getSignature(e, {signatureConstructor: a}).then(n.success, n.failure), n
        }

        function n(e, t, n) {
            var i, o = new DOMParser, s = o.parseFromString(t.responseText, "application/xml"),
        ...
        "use strict";
        var n = t.getName, i = t.log, o = e.clockDrift, r = 200, s = e.getBucket, a = e.getHost, u = e.getKeyName,
            l = e.filenameParam, c = e.paramsStore, d = e.endpointStore, p = e.aclStore,
            q = e.objectProperties.reducedRedundancy, h = e.objectProperties.region,
            f = e.objectProperties.serverSideEncryption, m = e.validation,
            g = qq.extend({region: h, drift: o}, e.signature), _ = this, v = e.signature.credentialsProvider, b = {
                combine: function (e) {
                    var t = _._getPersistableData(e).uploadId, n = _._getPersistableData(e).etags, i = new qq.Promise;
                    ...
                    var i = w.bucket.getName(e), o = w.host.getName(e), r = w.key.urlSafe(e), s = new qq.Promise,
                    ...
                    return S.restSignature.getSignature(e + "." + t, {signatureConstructor: a}).then(s.success, s.failure), s
                }, put: function (t, n) {
                    var o = _._createXhr(t, n), r = _._getChunkData(t, n), s = e.endpointStore.get(t), a = new qq.Promise;
                    return b.initHeaders(t, n, r.blob).then(function (e, u) {
                        if (o._cancelled) i(qq.format("Upload of item {}.{} cancelled. Upload will not start after successful signature request.", t, n)), a.failure({error: "Chunk upload cancelled"}); else {
                            var l = s + "/" + u;
                        ...
                        a.failure({error: "Problem signing the chunk!"}, o)
                    }), a
                }, send: function (e, t) {
                    var n = new qq.Promise;
                    ...
                    var t = new qq.Promise, n = _._getPersistableData(e).uploadId, i = new qq.Promise;
                ...
                policySignature: new qq.s3.RequestSigner({expectingPolicy: !0, signatureSpec: g, cors: e.cors, log: i}),
                restSignature: new qq.s3.RequestSigner({endpointStore: d, signatureSpec: g, cors: e.cors, log: i})
            }, y = {
                initParams: function (e) {
                    ...
                    var t = new qq.Promise, n = _._createXhr(e), o = _.getFile(e);
                    ...
                    var i = new FormData, o = d.get(e), r = o, s = new qq.Promise;
                ...
                bucket: {
                    promise: function (e) {
                        var t = new qq.Promise, n = _._getFileState(e).bucket;
                    ...
                    promise: function (e) {
                        var t = new qq.Promise, n = _._getFileState(e).host;
                    ...
                    var n = w.response.parse(e, t), o = n.success !== !0;
                    ...
                    promise: function (e) {
                        var t = new qq.Promise, i = _.getThirdPartyFileId(e);
                    ...
                    parse: function (e, t) {
                        ...
                        var t, n, i = new DOMParser, o = i.parseFromString(e, "application/xml"),
                            r = o.getElementsByTagName("Error"), s = {};
        ...
        qq.extend(this, {
            ...
            options: qq.extend({namespace: "s3"}, e),
            proxy: qq.extend({getEndpoint: e.endpointStore.get}, t)
            ...
            return {
                expunge: function (t) {
                    ...
                    var n = e._getLocalStorageId(t), i = w.bucket.getName(t);
                    return n + "-" + i
                }
            }
        })
        ...
        function o(t, n) {
            var o = new qq.Promise, r = "POST", u = e.endpointStore.get(t), l = c(t);
            return i(t).then(function (e) {
                var t = a._initFormForUpload({method: r, endpoint: u, params: e, paramsInBody: !0, targetName: n.name});
                o.success(t)
            }, function (e) {
                o.failure(e), s(t, n, l, {error: e})
            }), o
        }

        function r(e) {
            var t = a._createIframe(e), i = a.getInput(e), r = new qq.Promise;
        ...
        var a = this, u = e.clockDrift, l = t.onUuidChanged, c = t.getName, d = t.getUuid, p = t.log, q = e.getBucket,
            h = e.getKeyName, f = e.filenameParam, m = e.paramsStore, g = e.endpointStore, _ = e.aclStore,
            v = e.objectProperties.reducedRedundancy, b = e.objectProperties.region,
            S = e.objectProperties.serverSideEncryption, y = e.validation, w = e.signature,
            C = e.iframeSupport.localBlankPagePath, x = e.signature.credentialsProvider,
            E = new qq.s3.RequestSigner({signatureSpec: w, cors: e.cors, log: p});
        ...
        qq.extend(this, new qq.FormUploadHandler({
            ...
            proxy: {onCancel: e.onCancel, onUuidChanged: l, getName: c, getUuid: d, log: p}
        })), qq.extend(this, {
            uploadFile: function (e) {
                var t = c(e), n = new qq.Promise;
        ...
        qq.s3.FineUploader = function (e) {
            var t = {failedUploadTextDisplay: {mode: "custom"}};
        ...
        "use strict";
        return {
            AZURE_PARAM_PREFIX: "x-ms-meta-", _paramNameMatchesAzureParameter: function (e) {
                switch (e) {
                    case"Cache-Control":
                ...
                var t = {};
                return qq.each(e, function (e, n) {
                    var i = qq.azure.util._getPrefixedParamName(e), o = null;
                ...
                var n, i, o = new DOMParser, r = o.parseFromString(e, "application/xml"),
                    s = r.getElementsByTagName("Error")[0], a = {};
        ...
        qq.azure.FineUploaderBasic = function (e) {
            ...
            getBlobName: function (e) {
                ...
                var t = this._options.blobProperties.name, n = this.getUuid(e), i = this.getName(e),
                    o = qq.getExtension(i), r = n;
                ...
                var n = this, i = {}, o = {
                    ...
                    endpointStore: r, log: qq.bind(n.log, n), onDelete: function (e) {
                    ...
                    }, restRequestVerb: u.method, log: qq.bind(n.log, n)
                });
        ...
        function n(e) {
            ...
            return o(e).then(function (n) {
                var i = s._getMimeType(e), o = s._getPersistableData(e).blockIdEntries;
        ...
        function i(e) {
            var t = l.get(e), n = new qq.Promise, i = function (i) {
        ...
        function o(e, t) {
            var n = null == t ? e : e + "." + t, o = new qq.Promise, r = function (e) {
                a("GET SAS request succeeded."), o.success(e)
            }, s = function (e, t) {
                a("GET SAS request failed: " + e, "error"), o.failure({error: "Problem communicating with local server"}, t)
            }, u = function (e) {
                v.getSasForPutBlobOrBlock.request(n, e).then(r, s)
            }, l = function (t) {
                a(qq.format("Failed to determine blob name for ID {} - {}", e, t), "error"), o.failure({error: t})
            };
            return i(e).then(u, l), o
        }

        function r(e, t) {
            var n = qq.azure.util.parseAzureError(e.responseText, a), i = "Problem sending file to Azure";
            t.failure({error: i, azureError: n && n.message, reset: 403 === e.status})
        }

        var s = this, a = t.log, u = e.cors, l = e.endpointStore, c = e.paramsStore, d = e.signature,
            p = e.filenameParam, q = e.chunking.minFileSize, h = e.deleteBlob, f = e.onGetBlobName, m = t.getName,
            g = t.getSize, _ = function (e) {
                var t = c.get(e);
                return t[p] = m(e), t
            }, v = {
                putBlob: new qq.azure.PutBlob({getBlobMetadata: _, log: a}),
                putBlock: new qq.azure.PutBlock({log: a}),
                putBlockList: new qq.azure.PutBlockList({getBlobMetadata: _, log: a}),
        ...
        qq.extend(this, {
            uploadChunk: function (e, t) {
                ...
                return o(e, t).then(function (i) {
                    var o = s._createXhr(e, t), u = s._getChunkData(e, t);
                ...
                var t = new qq.Promise, n = s.getFile(e);
            ...
            options: qq.extend({namespace: "azure"}, e),
            proxy: qq.extend({getEndpoint: e.endpointStore.get}, t)
        })), qq.override(this, function (e) {
            return {
                expunge: function (t) {
                    var n = s._wasCanceled(t), i = s._getPersistableData(t), o = i && i.blockIdEntries || [];
        ...
        qq.extend(i, e), n = qq.extend(this, new qq.AjaxRequester({
            ...
            request: function (e, t) {
                var r = new qq.Promise, s = i.restRequestVerb;
        ...
        "use strict";
        var t, n = "DELETE", i = {
            endpointStore: {}, onDelete: function (e) {
            }, onDeleteComplete: function (e, t, n) {
            }, log: function (e, t) {
            }
        };
        ...
        qq.extend(i, e), t = qq.extend(this, new qq.AjaxRequester({
            ...
            method: n, upload: function (e, n, s, a) {
                var u = new qq.Promise;
                return i.log("Submitting Put Blob request for " + e), r[e] = u, o[e] = s, t.initTransport(e).withPayload(a).withHeaders({"Content-Type": a.type}).send(n), u
            }
        })
        ...
        function t(e) {
            var t = 5, n = new Array(t + 1).join("0"), i = (n + e).slice(-t);
            return btoa(i)
        }
        ...
        qq.extend(s, e), n = qq.extend(this, new qq.AjaxRequester({
            ...
            method: i, upload: function (e, i, u, l, c) {
                var d = new qq.Promise, p = t(l);
        ...
        qq.extend(r, e), n = qq.extend(this, new qq.AjaxRequester({
            ...
            method: i, send: function (e, i, a, u, l) {
                var c, d = new qq.Promise, p = t(a);
                return o[e] = d, r.log(qq.format("Submitting Put Block List request for {}", e)), s[e] = qq.format("{}&comp=blocklist", i), c = n.initTransport(e).withPayload(p).withHeaders({"x-ms-blob-content-type": u}).send(), l(c), d
            }
        })
    }, function () {
        "use strict";
